...
namespace Cryptlex
{
    public sealed class LexActivator
    {
        private static ILexActivator _lexActivator = new NativeLibraryBuilder().ActivateInterface<ILexActivator>("LexActivator");

        public static ILexActivator Instance
        {
            get
            {
